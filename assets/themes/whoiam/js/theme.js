(function($) {
      ...
      $('#contactForm, #hireForm').submit(function() {
        ...
        if (el.valid()) {
          ...
          $.ajax({
            type: 'POST',
            data: params,
            url: "assets/themes/whoiam/php/sending_mail.php",
            beforeSend: function() {
  ...
  function initCaptcha() {
    $('#mycaptcha').simpleCaptcha({
      allowRefresh: false,
      scriptPath: "assets/themes/whoiam/js/simpleCaptcha/simpleCaptcha.php"
    });
    ...
    $('#map-contact').gmap({
      ...
      'callback': function() {
        ...
        self.addMarker({
          ...
          icon: 'assets/themes/whoiam/images/marker.png'
        }).click(function() {
          self.openInfoWindow({
